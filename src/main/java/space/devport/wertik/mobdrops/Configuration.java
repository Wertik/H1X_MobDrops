...
public class Configuration {
    ...
    public String getColoredListString(String path) {
        List<String> msgList = color(getColoredList(path));
        StringBuilder strB = new StringBuilder();

        msgList.forEach(line -> strB.append(line).append("\n"));
    ...
    private List<String> color(List<String> list) {
        ...
        list.forEach(line -> out.add(color(line)));
        return out;
    }
}
